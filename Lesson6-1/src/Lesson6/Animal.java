...
abstract class Animals {
    ...
    public void jump(double height) {// выводит инфо об объекте относительно действия
        if (this.maxJamp <= height)
            System.out.println(this.type + " " + this.name + " может и прыгнуть на " + height + " м.");
        else System.out.println(this.type + " " + this.name + " не смогу так высоко прыгнуть.");
    }


    public void info() {
        System.out.println(this.type + " " + this.name + " Бежать: " + this.maxRun + " m., Плыть: " + this.maxSwim + " м., Прыгать:" + this.maxJamp + "м.");
    }
}
